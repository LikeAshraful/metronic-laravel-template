    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Update BHT</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">Edit BHT</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="add_psychiatrist" class="collapse show" style="">
                    ...
                    <form id="add_psychiatrist_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        method="POST" action="{{route('nurses.update', $nurse->id)}}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true"
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px"
                                            style="background-image: url({{$nurse->getFirstMediaUrl('avatar', 'thumb')}});">
                                        </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
									<input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="Name" value="{{$nurse->name}}" >
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
									<input type="text" name="phone" class="form-control form-control-lg form-control-solid" value="{{ $nurse->phone }}" placeholder="phone" >
                                    @error('phone')
                                        <div class="fv-plugins-message-container invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="email" name="email" class="form-control required form-control-lg form-control-solid" placeholder="Email" value="{{$nurse->email}}">
                                ...
                                <div class="col-lg-8 d-flex align-items-center">
                                    <div class="form-check form-check-solid form-check-custom form-switch fv-row">
                                        ...
                                        <input class="form-check-input w-45px h-30px" type="checkbox"
                                            id="security_status" name="security_status" value="1" {{$nurse->security_status == 1 ? 'checked' : ''}}>
							...
							<div class="row mb-0">
                                ...
                                <div class="col-lg-8 d-flex align-items-center">
                                    <div class="form-check form-check-solid form-check-custom form-switch fv-row">
                                        ...
                                        <input class="form-check-input w-45px h-30px" type="checkbox"
                                            id="active_status" name="active_status" value="1" {{$nurse->active_status == 1 ? 'checked' : ''}}>
