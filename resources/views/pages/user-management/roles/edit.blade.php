    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Update Role
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                    ...
                    <form id="add_reasons_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
                        ...
                        <div class="card-body border-top p-9">
                            <div class="row mb-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="name"
                                            class="form-control form-control-lg form-control-solid" value="{{$role->name}}">
                                        @error('name')
                                ...
                                <div class="mt-3">
                                    <label for="" class="col-lg-4 col-form-label required fw-bold fs-6">Roles</label>
                                    <div class="col-lg-8 fv-row">
                                    ...
                                    <select class="form-select form-select-solid form-control form-control-lg form-control-solid" name="permissions[]" data-control="select2"
                                        data-placeholder="Select a role" data-allow-clear="true" multiple="multiple">
