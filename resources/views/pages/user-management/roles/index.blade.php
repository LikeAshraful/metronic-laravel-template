        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Role Listing</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            @can('role.create')
                                <a href="{{ route('roles.create') }}" class="btn btn-sm fw-bold btn-primary">Add Role</a>
                            @endcan
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                                        ...
                                        <tr class="text-center">                                            
                                            ...
                                            <td>
                                                ...
                                                @foreach ($role->permissions as $permission)
                                                    <div class="badge badge-light-success">{{ $permission->name }}</div>
                                                @endforeach
